...
const String tLoginSubTitle = "Hora de gerenciar o seu negócio";
...
const String tClientBusinessList = "Clientes cadastrados";
const String tRegisterClientBusiness = "Registrar um novo cliente";
